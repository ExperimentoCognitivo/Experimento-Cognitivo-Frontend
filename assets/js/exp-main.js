...
async function endAndPass(element) {
    try {
        let nextPage = confirm("Essa é toda informação para responder às perguntas e você não deve retornar para essa página.\n Clique em OK para continuar ou cancel para permanecer na página");
        if (nextPage) {
