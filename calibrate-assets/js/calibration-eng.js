...
$(document).ready(function () {
  ...
  $(".Calibration").click(function () { // click event on the calibration buttons
    ...
    if (PointCalibrate >= 9) { // last point is calibrated
      ...
      swal({
        title: "Última etapa",
        text: "Please, after clicking OK, do not move the mouse and look at the middle point for the next 5 seconds.",
        closeOnEsc: false,
        ...
        $(document).ready(function () {
          ...
          sleep(5000).then(() => {
            ...
            swal({
              title: `Calibration completed successfully, click OK to start the experiment.`,
              allowOutsideClick: false,
              buttons: {
                confirm: true
              }
